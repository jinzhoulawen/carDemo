...
(this,function(){var e,t,n=Array,r=n.prototype,o=Object,i=o.prototype,a=Function,
    c=a.prototype,s=String,u=s.prototype,l=Number,f=l.prototype,p=r.slice,
    h=r.splice,d=r.push,y=r.unshift,g=r.concat,v=r.join,b=c.call,m=c.apply,
    w=Math.max,O=Math.min,T=i.toString,j="function"==typeof Symbol&&"symbol"==typeof Symbol.toStringTag,
    x=Function.prototype.toString,E=/^\s*class /,S=function(e){try{var t=x.call(e),n=t.replace(/\/\/.*\n/g,""),
        r=n.replace(/\/\*[.\s\S]*\*\//g,""),o=r.replace(/\n/gm," ").replace(/ {2}/g," ");
    return E.test(o)}catch(i){return!1}},D=function(e){try{return!S(e)&&(x.call(e),!0)}catch(t){return!1}},
    _="[object Function]",M="[object GeneratorFunction]",e=function(e){if(!e)return!1;
    if("function"!=typeof e&&"object"!=typeof e)return!1;
    if(j)return D(e);if(S(e))return!1;var t=T.call(e);
    return t===_||t===M},P=RegExp.prototype.exec,I=function(e){try{return P.call(e),!0}catch(t){return!1}},
    C="[object RegExp]";t=function(e){return"object"==typeof e&&(j?I(e):T.call(e)===C)};
    var F,N=String.prototype.valueOf,k=function(e){try{return N.call(e),!0}catch(t){return!1}},
        z="[object String]";F=function(e){return"string"==typeof e||"object"==typeof e&&(j?k(e):T.call(e)===z)};
        var R=o.defineProperty&&function(){try{var e={};o.defineProperty(e,"x",{enumerable:!1,value:e});
        for(var t in e)return!1;
        return e.x===e}catch(n){return!1}}(),$=function(e){var t;return t=R?function(e,t,n,r)
        {!r&&t in e||o.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:!0,value:n})}:function(e,t,n,r){!r&&t in e||(e[t]=n)},
            function(n,r,o){for(var i in r)e.call(r,i)&&t(n,i,r[i],o)}}(i.hasOwnProperty),
            U=function(e){var t=typeof e;return null===e||"object"!==t&&"function"!==t},
            A=l.isNaN||function(e){return e!==e},L={ToInteger:function(e){var t=+e;
            return A(t)?t=0:0!==t&&t!==1/0&&t!==-(1/0)&&(t=(t>0||-1)*Math.floor(Math.abs(t))),t},ToPrimitive:function(t)
                {var n,r,o;if(U(t))return t;if(r=t.valueOf,e(r)&&(n=r.call(t),U(n)))return n;if(o=t.toString,e(o)&&(n=o.call(t),U(n)))return n;
                throw new TypeError},ToObject:function(e){if(null==e)throw new TypeError("can't convert "+e+" to object");
                return o(e)},ToUint32:function(e){return e>>>0}},X=function(){};
        $(c,{bind:function(t){var n=this;if(!e(n))throw new TypeError("Function.prototype.bind called on incompatible "+n);
        for(var r,i=p.call(arguments,1),c=function(){if(this instanceof r){var e=m.call(n,this,g.call(i,p.call(arguments)));
            return o(e)===e?e:this}return m.call(n,t,g.call(i,p.call(arguments)))},s=w(0,n.length-i.length),u=[],l=0;l<s;l++)d.call(u,"$"+l);
        return r=a("binder","return function ("+v.call(u,",")+"){ return binder.apply(this, arguments); }")(c),n.prototype&&(X.prototype=n.prototype,
            r.prototype=new X,X.prototype=null),r}});
        var B=b.bind(i.hasOwnProperty),G=b.bind(i.toString),J=b.bind(p),q=m.bind(p),Z=b.bind(u.slice),H=b.bind(u.split),
            W=b.bind(u.indexOf),Y=b.bind(d),Q=b.bind(i.propertyIsEnumerable),V=b.bind(r.sort),K=n.isArray||function(e){return"[object Array]"===G(e)},
            ee=1!==[].unshift(0);$(r,{unshift:function(){return y.apply(this,arguments),this.length}},ee),$(n,{isArray:K});
            var te=o("a"),ne="a"!==te[0]||!(0 in te),re=function(e){var t=!0,n=!0,r=!1;if(e)try{e.call("foo",function(e,n,r){"object"!=typeof r&&(t=!1)}),
                e.call([1],function(){"use strict";n="string"==typeof this},"x")}catch(o){r=!0}return!!e&&!r&&t&&n};
            $(r,{forEach:function(t){var n,r=L.ToObject(this),o=ne&&F(this)?H(this,""):r,i=-1,a=L.ToUint32(o.length);
            if(arguments.length>1&&(n=arguments[1]),!e(t))throw new TypeError("Array.prototype.forEach callback must be a function");
            for(;++i<a;)i in o&&("undefined"==typeof n?t(o[i],i,r):t.call(n,o[i],i,r))}},!re(r.forEach)),
                $(r,{map:function(t){var r,o=L.ToObject(this),i=ne&&F(this)?H(this,""):o,a=L.ToUint32(i.length),c=n(a);
                if(arguments.length>1&&(r=arguments[1]),!e(t))throw new TypeError("Array.prototype.map callback must be a function");
                for(var s=0;s<a;s++)s in i&&("undefined"==typeof r?c[s]=t(i[s],s,o):c[s]=t.call(r,i[s],s,o));return c}},!re(r.map)),
                $(r,{filter:function(t){var n,r,o=L.ToObject(this),i=ne&&F(this)?H(this,""):o,a=L.ToUint32(i.length),c=[];
                if(arguments.length>1&&(r=arguments[1]),!e(t))throw new TypeError("Array.prototype.filter callback must be a function");
                for(var s=0;s<a;s++)s in i&&(n=i[s],("undefined"==typeof r?t(n,s,o):t.call(r,n,s,o))&&Y(c,n));return c}},
                    !re(r.filter)),$(r,{every:function(t){var n,r=L.ToObject(this),o=ne&&F(this)?H(this,""):r,i=L.ToUint32(o.length);
                    if(arguments.length>1&&(n=arguments[1]),!e(t))throw new TypeError("Array.prototype.every callback must be a function");
                    for(var a=0;a<i;a++)if(a in o&&!("undefined"==typeof n?t(o[a],a,r):t.call(n,o[a],a,r)))return!1;return!0}},!re(r.every)),
                $(r,{some:function(t){var n,r=L.ToObject(this),o=ne&&F(this)?H(this,""):r,i=L.ToUint32(o.length);if(arguments.length>1&&(n=arguments[1]),
                        !e(t))throw new TypeError("Array.prototype.some callback must be a function");
                for(var a=0;a<i;a++)if(a in o&&("undefined"==typeof n?t(o[a],a,r):t.call(n,o[a],a,r)))return!0;return!1}},
                    !re(r.some));var oe=!1;r.reduce&&(oe="object"==typeof r.reduce.call("es5",function(e,t,n,r){return r})),
        $(r,{reduce:function(t){var n=L.ToObject(this),r=ne&&F(this)?H(this,""):n,o=L.ToUint32(r.length);
        ...
        var i,a=0;if(arguments.length>=2)i=arguments[1];else for(;;){if(a in r){i=r[a++];
                    break}if(++a>=o)throw new TypeError("reduce of empty array with no initial value")}
                    for(;a<o;a++)a in r&&(i=t(i,r[a],a,n));return i}},!oe);var ie=!1;r.reduceRight&&(ie="object"==typeof r.reduceRight.call("es5",function(e,t,n,r)
    {return r})),$(r,{reduceRight:function(t){var n=L.ToObject(this),r=ne&&F(this)?H(this,""):n,o=L.ToUint32(r.length);
